 ...
 * @since 2011年7月23日
 */
public abstract class LeafMonitorPane extends JComponent {
	...
	/**
	 * 100段階表示の{@link leaf.swing.LeafMonitorPane}を作成します。
	 */
	public LeafMonitorPane() {
		this(100);
	}

	/**
	 * 観測対象量の量子化段階数を指定して{@link leaf.swing.LeafMonitorPane}を作成します。
	 *
	 * @param step 量子化段階数
	 */
	public LeafMonitorPane(final int step) {
		super();
		this.step = step;
