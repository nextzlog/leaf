 ...
 * @param <E> 要素の総称型
 */
public class JCheckList<E> extends JComponent implements Scrollable {
	 ...
	 * @param model モデル
	 */
	public JCheckList(ListModel<E> model) {
	...
	private class CheckBoxItem extends JCheckBox {
		...
		public CheckBoxItem(Object item) {
			...
			addItemListener(JCheckList.this.itemListener);
		}
