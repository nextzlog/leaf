...
/**
*Leafのネットワーク通信機能を提供するサーバーの実装です。<br>
...
public class LeafNetServer{
	...
	*/
	...
	/**
	*サーバー上に存在する全てのルームの配列を表すArrayListを返します。
	*@return 全ての{@link LeafNetRoom}のリスト
	*/
	public ArrayList<LeafNetRoom> getRoomList(){
		return rooms;
	}
	/**
	...
	*/
	public synchronized void clearCharRooms(){
		rooms.clear();
	...
	*/
	...
	/**
	*このサーバー上に存在する全てのメンバーの配列を表すArrayListを返します。
	*@return 全てのメンバーのリスト
	*/
