 ...
 */
public class LeafSyntaxDocument extends DefaultStyledDocument{
	 ...
	 *@since 2011年2月22日
	 */
	public LeafSyntaxDocument(KeywordSet set){
		this();
		setKeywordSet(set);
	}
	/**
	 *設定を{@link LeafSyntaxManager}から読み込んで表示を更新します。
	 */
	public void update(){
