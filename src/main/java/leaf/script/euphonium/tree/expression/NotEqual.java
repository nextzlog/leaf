...
import static leaf.script.common.util.LeafCalcUnit.notequal;

import javax.script.ScriptException;

/**
 *構文解析木で非等価演算子を表現するノードの実装です。
 *
 *@author 東大アマチュア無線クラブ
 *@since  Leaf 1.3 作成：2011年11月27日
 */
public final class NotEqual extends RelationalNode{
	/**
	 *左右の子を指定してノードを生成します。
	 *@param a 左の子
	 *@param b 右の子
	 */
	public NotEqual(Node a, Node b){
		super(a, b);
	}
	/**
	 *解析木の値を再帰的に計算して返します。
