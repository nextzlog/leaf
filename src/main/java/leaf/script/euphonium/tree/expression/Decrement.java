...
import static leaf.script.common.util.LeafCalcUnit.decrement;

import javax.script.ScriptException;

/**
 *構文解析木でデクリメント演算子を表現するノードの実装です。
 *
 *@author 東大アマチュア無線クラブ
 *@since  Leaf 1.3 作成：2011年11月27日
 */
public final class Decrement extends UnaryNode{
	/**
	 *子を指定してノードを生成します。
	 *@param child 子
	 */
	public Decrement(Node child){
		super(child);
	}
	/**
	 *解析木の値を再帰的に計算して返します。
