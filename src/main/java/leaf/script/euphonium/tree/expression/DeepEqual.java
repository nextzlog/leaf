...
import static leaf.script.common.util.LeafCalcUnit.deepequals;

import javax.script.ScriptException;

/**
 *構文解析木で構造的等価(深い等価)演算子を表現するノードの実装です。
 *
 *@author 東大アマチュア無線クラブ
 *@since  Leaf 1.3 作成：2011年8月21日
 */
public final class DeepEqual extends RelationalNode{
	/**
	 *左右の子を指定してノードを生成します。
	 *@param a 左の子
	 *@param b 右の子
	 */
	public DeepEqual(Node a, Node b){
		super(a, b);
	}
	/**
	 *解析木の値を再帰的に計算して返します。
	...
	public Code value() throws ScriptException{
		return deepequals(left().value(), right().value());
	}
	/**
