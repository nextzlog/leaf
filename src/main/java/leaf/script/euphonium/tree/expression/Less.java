...
import static leaf.script.common.util.LeafCalcUnit.isLess;
 ...
 */
public final class Less extends RelationalNode{
	/**
	 *左右の子を指定してノードを生成します。
	 *@param a 左の子
	 *@param b 右の子
	 */
	public Less(Node a, Node b){
		super(a, b);
	}
	/**
	 *解析木の値を再帰的に計算して返します。
	...
	public Code value() throws ScriptException{
		return isLess(left().value(), right().value());
	}
	/**
