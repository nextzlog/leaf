...
import static leaf.script.arice.AriceScriptEngine.FRAME_NEST_MAX;
import static leaf.script.arice.AriceScriptEngine.STACK_SIZE_MAX;
import static leaf.script.arice.AriceScriptEngine.EXECUTE_STEP_MAX;
...
final class AriceVirtualMachine extends AriceCodesAndTokens{
	...
	private final AriceClosureTable closures;
	...
	*/
	public AriceVirtualMachine(){
		...
		closures = new AriceClosureTable();
