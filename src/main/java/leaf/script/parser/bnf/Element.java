...
/**
 * BNF構文規則表現において、構文を規定する全ての要素の根底となるクラスです。
 *
 *
 * @author 東大アマチュア無線クラブ
...
public abstract class Element {
	 ...
	 */
	public abstract void parse(Lexer lexer, NodeList result)
	 ...
	 * @throws ScriptException 構文エラーがあった場合にスローされます。
	 */
	public abstract boolean match(Lexer lexer) throws ScriptException;
}
