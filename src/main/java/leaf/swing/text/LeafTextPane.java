...
import leaf.document.LeafEditorKit;
...
public class LeafTextPane extends JTextPane {
	...
	/**
	 *デフォルトのエディタキットとして{@link LeafEditorKit}を作成します。
	 *
	 *@return エディタキット
	 *@see LeafEditorKit
	 */
	 ...
	 *このコンポーネントを描画します。
	 *
	 *@param g このコンポーネントを描画するのに用いるグラフィックス
	 */
	...
	/**
	 *指定した括弧を指定位置より前から検索します。
	 *
	 *@param index 検索開始位置
	 *@param brace 括弧の文字
	 *@param pair  対応する括弧
	 *
	 *@return 対応する括弧の位置 存在しない場合-1
	 */
	...
	/**
	 *キーボードの操作を監視します。例えばINSERTキーでキャレット動作を切り替えます。
	 *
	 *@param e キーイベント
	 */
