...
public final class LocalizeManager {
	...
	private static WeakHashMap<Class<?>, LocalizeManager> map;
	private static final HashMap<String, File> roots;
	
	static{
		roots = new HashMap<String, File>();
		map = new WeakHashMap<Class<?>, LocalizeManager>();
	}
	...
	public static LocalizeManager get(Class<?> clazz) {
		LocalizeManager instance = map.get(clazz);
		if(instance == null) {
	...
	public static void setLocale(Locale locale) {
		if(locale == null) {
			LocalizeManager.locale = Locale.ENGLISH;
		}
	...
	public boolean available(Locale locale) {
		...
		if(root == null) try {
			...
			JarEntry dir = jar.getJarEntry(getDir(locale, "/"));
